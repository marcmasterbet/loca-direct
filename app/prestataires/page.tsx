...
export const metadata: Metadata = {
  ...
  description:
    "Trouvez gratuitement des prestataires pour votre logement : conciergerie, ménage, photographe, aide au digital. Annuaire vérifié, contact direct par WhatsApp ou téléphone.",
  openGraph: {
...
export default async function PrestatairesPage() {
  ...
  return <PrestatairesClient prestataires={prestataires || []} />
}
